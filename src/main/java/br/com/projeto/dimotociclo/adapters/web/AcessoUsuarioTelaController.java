...
import br.com.projeto.dimotociclo.infraestructure.mappers.AcessoUsuarioTelaMappers;
...
public class AcessoUsuarioTelaController {
    ...
    @PostMapping
    public void savarAcesso(@RequestBody UsuarioAcessos acessoUsuarioTelaRequest) {

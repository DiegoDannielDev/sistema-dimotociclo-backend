...
import br.com.projeto.dimotociclo.adapters.integration.jpa.entity.*;
import br.com.projeto.dimotociclo.adapters.integration.jpa.entity.pk.FornecedorProdutosEntityPk;
import br.com.projeto.dimotociclo.adapters.integration.jpa.mappers.ProdutosComprasJpaMapper;
import br.com.projeto.dimotociclo.adapters.integration.jpa.repository.*;
import br.com.projeto.dimotociclo.domain.model.ProdutoDTO;
import br.com.projeto.dimotociclo.domain.model.ProdutoModel;
import br.com.projeto.dimotociclo.adapters.integration.jpa.port.ProdutoPort;
  ...
  private ValoresProdutosEntity salvarValorProduto(
    ...
    return this.valoresProdutosJPA.save(
        ValoresProdutosEntity.builder()
            .produtoEntity(produtoEntity)
            .dataInclusao(LocalDateTime.now())
            .valorVendaVarejo(produtoDTO.getValorVendaVarejo())
            .valorLucroVendaVarejo(produtoDTO.getValorLucroVendaVarejo())
            .valorLucroVendaAtacadado(produtoDTO.getValorLucroVendaAtacadado())
            .valorCompraProdutoUnitario(produtoDTO.getValorCompraProdutoUnitario())
            .margemVendaAtacado(produtoDTO.getMargemVendaAtacado())
            .margemVendaVarejo(produtoDTO.getMargemVendaVarejo())
            .valorCompra(produtoDTO.getValorTotalCompra())
            .valorAtacado(produtoDTO.getValorVendaAtacado())
            .build());
  }
